...
void printTutorial() {
	...
	cout << "\n\n\n Witaj w grze milionerzy, z tej strony Ce'plus-plus Urbañski, zaraz zaczynamy nasz teleturniej!" << endl << endl << endl;
...
int main()
{
	...
	while (isRunning && !resigned) {
		...
		case -1:
			if (questionNumber > 0) {
				resigned = true;
				cout << "\n-----------Zrezygnowano z pytania-----------" << endl << endl;
			}
			else {
